...
const UsersDetail = () => {
    ...
    const userToShow = context.userToShow || { name: { first: '', last: '' }, image: '', description: '' };
    ...
    return (
        <aside className={`${context.isUserDetailOpen ? 'flex' : 'hidden'} user-detail flex-col fixed right-0 top-16 border border-gray-300 rounded-lg bg-white shadow-lg p-4 transition-all duration-300 z-50`}>
